...
def read_dataset():
    dataset = datasets.load_dataset("/sgl-workspace/nano-vllm/tmp/aime_2024")
...
def main():
    ...
    path = Path("~/.cache/modelscope/hub/models/Qwen/Qwen3-8B").expanduser()
...
# python aime.py -f qwen3_4B_aime.jsonl -c
# python aime.py -f drop_qwen3_4B_aime.jsonl -b 1
# python aime.py -t
# python aime.py -f qwen3_0_6B_aime.jsonl -c